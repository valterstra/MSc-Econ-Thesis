...
* ============================================================================
* Joint t-GARCH spillover model with congestion interaction
*
* SE3: north_wind_log x D_congested_SE2SE3
* SE4: north_wind_log x D_congested_SE3SE4
* ============================================================================

global DATA_FILE "stata_input/congestion_spillover/congestion_spillover_SE3_2023-01-01_2023-12-31_log.csv"
...
local cong_terms "north_wind_log d_congested north_wind_cong"
...
if $HET_INCLUDE_CONGESTION {
    local het_controls `het_controls' d_congested north_wind_cong
}
...
local out_dir "output from stata/garch_results/congestion_spillover"
...
quietly {
    use `out_file', clear
    local stub = subinstr("$DATA_FILE", "stata_input/congestion_spillover/congestion_spillover_", "", 1)
    local stub = subinstr("`stub'", ".csv", "", 1)
    export delimited using "`out_dir'/garch_results_`stub'_joint`df_label'_congspill.csv", replace
}
