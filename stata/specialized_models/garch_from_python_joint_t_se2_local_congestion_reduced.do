...
global DATA_FILE "stata_input/local_congestion/local_congestion_SE2_2025-01-01_2025-12-31_log.csv"
global T_DF 5
local arma_p = 1
local arma_d = 0
local arma_q = 1
...
local controls "wind_log consump_log_ds d_congested wind_cong"
...
quietly {
    ...
    export delimited using "`out_dir'/garch_results_`stub'_joint`df_label'_localcong_reduced.csv", replace
}
