...
def detect_outliers(df, zone, plots_dir='plots'):
    """
    Detect outliers using Gianfreda (2010) / Mugele et al. (2005) methodology.
...
def run_visualizations(data, zone, stage='raw', plots_dir='plots'):
    ...
    csv_path = os.path.join(zone_plots_dir, f'outlier_summary_gianfreda_{stage}_{zone}.csv')
    ...
    print(f"  6. outlier_summary_gianfreda_{stage}_{zone}.csv - Outlier detection statistics")
