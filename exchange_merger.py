...
output_filename = f'Verified_{target_region}_Exchange_2021_2024.xlsx'
...
if not os.path.exists(folder_path):
    ...
    # Filter files for 2021-2024 and remove duplicates
...
if all_days_data:
    ...
    print("\n" + "=" * 40)
    print(f"Final Output Count: {len(final_df)} rows")
    if not gaps.empty:
